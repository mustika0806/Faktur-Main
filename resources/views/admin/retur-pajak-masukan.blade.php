...
@section('main-content')
    ...
    <section id="hero" class="hero">
        <div class="pagetitle">
            <h1>Retur Pajak Masukan</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Faktur</a></li>
                    <li class="breadcrumb-item active">Retur Pajak Masukan</li>
                </ol>
            </nav>
        </div> <!--End Page Title -->
                ...
                <div class="container-fluid p-0">
                    <div class="card">
                        <div class="card-header">
                            <button class="btn" type="submit" data-bs-toggle="modal" data-bs-target="#rekamReturMasukan"
                        ...
                        <!--Modal-->
                        <!-- The Modal -->
                        <div class="modal" id="rekamReturMasukan">
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">

                                    <!-- Modal Header -->
                                    <div class="modal-header">
                                        <h4 class="modal-title">Retur Faktur Pajak Masukan</h4>
